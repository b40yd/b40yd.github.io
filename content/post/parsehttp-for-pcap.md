...
## 2. 核心架构设计 {#2-dot-核心架构设计}


## 2.1 双向流匹配：FlowKey {#2-dot-1-双向流匹配-flowkey}
...
## 3. 代码实现详解 {#3-dot-代码实现详解}


## 3.1 状态转移逻辑 {#3-dot-1-状态转移逻辑}
...
## 3.2 SSE 的特殊处理 {#3-dot-2-sse-的特殊处理}
...
## 4. 运行与场景示例 {#4-dot-运行与场景示例}


## 场景：分析 MCP 会话 {#场景-分析-mcp-会话}
